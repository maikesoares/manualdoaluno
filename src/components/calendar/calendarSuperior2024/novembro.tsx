...
const monthData: Record<string, MonthData> = {
  '2024-11': {
      events: {
        ...
        '2024-11-28': { periods: [{ endingDay: true, color: '#7108b8' }] },
        '2024-11-29': { periods: [{ endingDay: true, color: '#7108b8' }] },
        '2024-11-30': { periods: [
          { endingDay: true, color: '#7108b8' },
          { endingDay: true, color: '#c0bd13' }
        ] },
      ...
      legends: [
        '02 – Finados',
        '04 – Data limite para envio do plano de ensino referente ao 2º semestre de 2024',
        '9 – Sábado letivo referente a terça-feira',
        '11 – Data limite para solicitação de direito de ausência em razão de guarda religiosa',
        '11 – Data limite para solicitação de aproveitamento de disciplinas, de experiências e de conhecimentos anteriores',
        ...
        '28 a 30 - Semana do curso: Engenharia Civil',
