...
const monthData: Record<string, MonthData> = {
  '2024-07': {
      events: {
        '2024-07-06': { periods: [{ endingDay: true, color: '#c0bd13' }] },
        '2024-07-13': { periods: [{ endingDay: true, color: '#c0bd13' }] },
      ...
      legends: [
        ...
        '6 – Sábado letivo referente a segunda-feira',
        '13 – Sábado letivo referente a sexta-feira',
