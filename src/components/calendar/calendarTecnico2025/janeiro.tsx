...
const monthData: Record<string, MonthData> = {
  '2025-01': {
      events: {
        ...
        '2025-01-20': { periods: [{ endingDay: true, color: '#159da7' }] },
        '2025-01-25': { periods: [{ endingDay: true, color: '#c0bd13' }] },
        '2025-01-28': { periods: [{ endingDay: true, color: '#84f875' }] },
        '2025-01-29': { periods: [{ endingDay: true, color: '#84f875' }] },
        '2025-01-30': { periods: [{ endingDay: true, color: '#84f875' }] },
      ...
      legends: [
        ...
        '20 – Início da etapa 2',
        '25 – Sábado letivo referente a quarta-feira',
        '28 a 30 – Conselho de classe (extra-turno)',
