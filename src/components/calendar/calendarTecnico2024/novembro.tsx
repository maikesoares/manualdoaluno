...
const monthData: Record<string, MonthData> = {
  '2024-11': {
      events: {
        ...
        '2024-11-30': { periods: [{ endingDay: true, color: '#c0bd13' }] },
      },
      legends: [
        '02 – Finados',
        ...
        '11 – Data limite para solicitação de aproveitamento de estudos, de experiências e de conhecimentos anteriores',
