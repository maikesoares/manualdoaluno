...
const monthData: Record<string, MonthData> = {
  '2024-08': {
    events: {
      ...
      '2024-08-12': { periods: [{ endingDay: true, color: '#159da7' }] },
      '2024-08-13': { periods: [{ endingDay: true, color: '#84f875' }] },
      '2024-08-14': { periods: [{ endingDay: true, color: '#84f875' }] },
      '2024-08-15': { periods: [{ endingDay: true, color: '#84f875' }] },
    ...
    legends: [
      ...
      '10 – Término da etapa 1',
      '10 – Sábado letivo referente a terça-feira',
      '12 – Início da etapa 2',
      '12 – Data limite para entrega dos resultados parciais referentes à etapa 1',
      '13 a 15 – Conselhos de classe (extra-turno)',
      '16 – Data limite para solicitação de dilação de prazo de integralização de curso em período subsequente',
