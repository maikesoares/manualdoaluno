...
const CalendarAcademicoMedio: React.FC = () => {
  ...
  async function carregarEventos() {
    const querySnapshot = await getDocs(collection(db, 'eventosAcademicosMedio'));
  ...
  const salvarEvento = async () => {
    ...
    await setDoc(doc(db, 'eventosAcademicosMedio', evento.data), evento);
    ...
    Alert.alert(
      ...
      [
        { text: 'Cancelar', style: 'cancel' },
        {
          ...
          style: 'destructive',
          onPress: async () => {
            await deleteDoc(doc(db, 'eventosAcademicosMedio', eventoData.trim()));
            setModalVisible(false);
            carregarEventos();
          },
        },
