...
export default function EditarMoradiaScreen() {
  ...
  return (
    <ScrollView contentContainerStyle={{ flexGrow: 1, backgroundColor: tintColorBackGround }}>
      <View style={styles.container}>
        ...
        <TextInput style={styles.input} value={novoTitle} onChangeText={setNovoTitle} />
        ...
        <TextInput style={styles.input} value={novoDownload} onChangeText={setNovoDownload} />
