    ...
    async function carregarConteudo() {
      try {
        ...
        if (docSnap.exists()) {
          ...
          console.warn('Documento "participacaoAEventos" não encontrado.');
        }
      } catch (error) {
    ...
    <ScrollView contentContainerStyle={servicosStyle.container}>
      <View style={servicosStyle.card}>
        <View style={servicosStyle.header}>
          <FontAwesome name="calendar" size={40} color={tintColorWhite} />
        ...
        {user && (
          <TouchableOpacity
            ...
            onPress={() =>
              router.push({
                pathname: '/(stacks)/editarParticipacaoAEventos',
                params: {
