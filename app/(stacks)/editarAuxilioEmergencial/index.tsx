...
export default function EditarAuxilioEmergencialScreen() {
  const router = useRouter();
  const { title, texto, subText, download } = useLocalSearchParams();
    ...
    <KeyboardAvoidingView
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        <View style={styles.container}>
          ...
          <Text style={styles.label}>Subtexto (opcional)</Text>
          <TextInput
            style={styles.input}
            value={novoSubText}
